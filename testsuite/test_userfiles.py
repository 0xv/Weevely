...
class FSUserFiles(SimpleTestCase):
    ...
    def test_userfiles(self):
        ...
        self.assertDictContainsSubset(
            expected_enum_map, self._res(":audit.userfiles"))
        self.assertDictContainsSubset(expected_enum_map, self._res(
            ":audit.userfiles -pathlist \"%s\"" % str(path_list)))
        self.assertDictContainsSubset(
            expected_enum_map, self._res(":audit.userfiles -auto-home"))
        self.assertDictContainsSubset(
            expected_enum_map, self._res(":audit.userfiles -pathfile %s" % temp_path.name))
